const CACHE='neon-player-x-v8-8-complete-3';
const APP=['./','./index.html','./style.css','./script.js','./creator-gift.bridge.js','./manifest.webmanifest','./icon-48.png','./icon-96.png','./icon-180.png','./icon-192.png','./icon-512.png','./favicon-32.png','./app-icon.jpg'];
